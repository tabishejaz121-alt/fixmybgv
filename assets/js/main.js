...
/* ---- Business contact config -------------------------------------------
   Every WhatsApp button/FAB and mailto link on the site reads from this
   single place.
   -------------------------------------------------------------------- */
const SITE_CONFIG = {
  whatsappNumber: "918618264354",
  email: "contact@fixmybgv.com",
...
function wireIntakeForm(form) {
  ...
  form.addEventListener("focusin", () => {
    ...
    /* URL marker for conversion tracking (e.g. a Google Ads/GA4 trigger on
       "URL contains form_started") — pushState only, no reload. */
    if (window.history && window.history.pushState) {
      const url = new URL(window.location.href);
      url.searchParams.set("form_started", "1");
      ...
      <div class="booking-modal-body">
        ...
        <div class="booking-step" data-step="form" style="display:none;">
          ...
          <form id="booking-modal-form" novalidate>
            ...
            <div class="field">
              <label for="booking-modal-full-name">Full name <span class="req">*</span></label>
              <input type="text" id="booking-modal-full-name" name="full_name" data-required autocomplete="name" placeholder="Your full name" />
            </div>
            <div class="field">
              <label for="booking-modal-mobile">Mobile / WhatsApp number <span class="req">*</span></label>
              <input type="tel" id="booking-modal-mobile" name="mobile" data-required autocomplete="tel" placeholder="+91 XXXXX XXXXX" />
            </div>
            <div class="field">
              <label for="booking-modal-email">Email address <span class="req">*</span></label>
              <input type="email" id="booking-modal-email" name="email" data-required autocomplete="email" placeholder="you@example.com" />
            </div>
            <div class="field">
              <label for="booking-modal-issue">Issue in detail <span class="req">*</span></label>
              <textarea id="booking-modal-issue" name="issue" data-required rows="4" placeholder="Describe your situation, what happened, which employer(s) are involved, and what's creating the problem right now."></textarea>
            </div>
